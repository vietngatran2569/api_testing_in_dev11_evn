...
//
response_1 = WS.sendRequest(findTestObject('Sub_Postman/Home/Transfer/transfer from wallet to wallet/Transfer ConfirmTransaction',
	[('link') : GlobalVariable.link,
	('tokenCus') : GlobalVariable.tokenCus,
...
//
response_2 = WS.sendRequest(findTestObject('Sub_Postman/Home/Transfer/transfer from wallet to wallet/Transfer VerifyTransaction',
	[('link') : GlobalVariable.link,
	('tokenCus') : GlobalVariable.tokenCus,
	('TRANSREFID') : GlobalVariable.TRANSREFID,
	 ('MessageType') : MessageType,
